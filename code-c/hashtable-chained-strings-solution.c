...
static hash_function_type hash_function = (hash_function_type)&hash_str;
...
int main(void) {
    ...
    hashtable_insert(h, "a", 77);
    hashtable_insert(h, "foo", 66);
    hashtable_insert(h, "bar", 99);
    hashtable_insert(h, "foobar", 55);
    ...
    hashtable_delete(h, "a");
    hashtable_print(h, 0, "after removal of key 'a' =");
    hashtable_delete_value(h, "foobar", 55);
    hashtable_print(h, 0, "after removal of element 55 =");

    // Testing new functionality
    HashTable *h2 = hashtable_init(10, (TInfo[]) { { "a", 7}, { "b", 8}, {"c", 9}, { "d", 10 } }, 4);
