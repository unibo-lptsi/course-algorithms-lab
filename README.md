...
1. Studio sorgente `01-intro-algorithms.py` (tempo richiesto: 30')
    ...
    - COSA FARE:
        ...
        3. approfondire la comprensione dello script, consultando slide e/o documentazione e/o consultando il docente
2. Estendere il sorgente dato implementando i seguenti algoritmi (con test):
...
3. Realizzare un nuovo script che implementi un algoritmo per il gioco `guess-a-number`
